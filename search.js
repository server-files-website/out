...
(function (e) {"function" === typeof define && define.amd ? define(["jquery"], e) : e(jQuery);})(function (e) {function g(a, b) {var c = function () {},c = { autoSelectFirst: !1, appendTo: "body", serviceUrl: null, lookup: null, onSelect: null, width: "auto", minChars: 1, maxHeight: 300, deferRequestBy: 0, params: {}, formatResult: g.formatResult, delimiter: null, zIndex: 9999, type: "GET", noCache: !1, onSearchStart: c, onSearchComplete: c, containerClass: "search-form-suggestions", tabDisabled: !1, dataType: "text", lookupFilter: function (a, b, c) {return -1 !==
        a.value.toLowerCase().indexOf(c);}, paramName: "query", transformResult: function (a) {return "string" === typeof a ? e.parseJSON(a) : a;} };this.element = a;this.el = e(a);this.suggestions = [];this.badQueries = [];this.selectedIndex = -1;this.currentValue = this.element.value;this.intervalId = 0;this.cachedResponse = [];this.onChange = this.onChangeInterval = null;this.isLocal = this.ignoreValueChange = !1;this.suggestionsContainer = null;this.options = e.extend({}, c, b);this.classes = { selected: "search-form-selected", suggestion: "search-form-suggestion" };
    this.initialize();this.setOptions(b);}var h = { extend: function (a, b) {return e.extend(a, b);}, createNode: function (a) {var b = document.createElement("div");b.innerHTML = a;return b.firstChild;} };g.utils = h;e.search-form = g;g.formatResult = function (a, b) {var c = "(" + b.replace(RegExp("(\\/|\\.|\\*|\\+|\\?|\\||\\(|\\)|\\[|\\]|\\{|\\}|\\\\)", "g"), "\\$1") + ")";return a.value.replace(RegExp(c, "gi"), "<strong>$1</strong>");};g.prototype = { killerFn: null, initialize: function () {var a = this,b = "." + a.classes.suggestion,c = a.classes.selected,
      d = a.options,f;a.element.setAttribute("search-form", "off");a.killerFn = function (b) {0 === e(b.target).closest("." + a.options.containerClass).length && (a.killSuggestions(), a.disableKillerFn());};if (!d.width || "auto" === d.width) d.width = a.el.outerWidth();a.suggestionsContainer = g.utils.createNode('<div class="' + d.containerClass + '" style="position: absolute; display: none;"></div>');f = e(a.suggestionsContainer);f.appendTo(d.appendTo).width(d.width);f.on("mouseover.search-form", b, function () {a.activate(e(this).data("index"));});
      f.on("mouseout.search-form", function () {a.selectedIndex = -1;f.children("." + c).removeClass(c);});f.on("click.search-form", b, function () {a.select(e(this).data("index"), !1);});a.fixPosition();if (window.opera) a.el.on("keypress.search-form", function (b) {a.onKeyPress(b);});else a.el.on("keydown.search-form", function (b) {a.onKeyPress(b);});a.el.on("keyup.search-form", function (b) {a.onKeyUp(b);});a.el.on("blur.search-form", function () {a.onBlur();});a.el.on("focus.search-form", function () {a.fixPosition();});}, onBlur: function () {this.enableKillerFn();},
    setOptions: function (a) {var b = this.options;h.extend(b, a);if (this.isLocal = e.isArray(b.lookup)) b.lookup = this.verifySuggestionsFormat(b.lookup);e(this.suggestionsContainer).css({ "max-height": b.maxHeight + "px", width: b.width + "px", "z-index": b.zIndex });}, clearCache: function () {this.cachedResponse = [];this.badQueries = [];}, clear: function () {this.clearCache();this.currentValue = null;this.suggestions = [];}, disable: function () {this.disabled = !0;}, enable: function () {this.disabled = !1;}, fixPosition: function () {var a;"body" === this.options.appendTo && (
      a = this.el.offset(), e(this.suggestionsContainer).css({ top: a.top + this.el.outerHeight() + "px", left: a.left + "px" }));}, enableKillerFn: function () {e(document).on("click.search-form", this.killerFn);}, disableKillerFn: function () {e(document).off("click.search-form", this.killerFn);}, killSuggestions: function () {var a = this;a.stopKillSuggestions();a.intervalId = window.setInterval(function () {a.hide();a.stopKillSuggestions();}, 300);}, stopKillSuggestions: function () {window.clearInterval(this.intervalId);}, onKeyPress: function (a) {if (!this.disabled &&
    ...
    suggest: function () {if (0 === this.suggestions.length) this.hide();else {var a = this.options.formatResult,b = this.getQuery(this.currentValue),c = this.classes.suggestion,d = this.classes.selected,f = e(this.suggestionsContainer),g = "";e.each(this.suggestions, function (d, e) {g += '<div class="' + c + '" data-index="' + d + '">' + a(e, b) + "</div>";});f.html(g).show();this.visible = !0;this.options.autoSelectFirst && (this.selectedIndex = 0, f.children().first().addClass(d));}}, verifySuggestionsFormat: function (a) {return a.length && "string" ===
      ...
      this.el.val(this.getValue(a.value));e.isFunction(b) && b.call(this.element, a);}, getValue: function (a) {var b = this.options.delimiter,c;if (!b) return a;c = this.currentValue;b = c.split(b);return 1 === b.length ? a : c.substr(0, c.length - b[b.length - 1].length) + a;}, dispose: function () {this.el.off(".search-form").removeData("search-form");this.disableKillerFn();e(this.suggestionsContainer).remove();} };e.fn.search-form = function (a, b) {return 0 === arguments.length ? this.first().data("search-form") : this.each(function () {var c =
      e(this),d = c.data("search-form");if ("string" === typeof a) {if (d && "function" === typeof d[a]) d[a](b);} else d && d.dispose && d.dispose(), d = new g(this, a), c.data("search-form", d);});};});
...
$(function () {
  ...
  // setup search-form function pulling from currencies[] array
